...
var a = Rectangle(width: 10, height: 5)
print(a.area)
...
struct Height {
    ...
    var heightInCentimeters: Double{
        didSet{
            let inCentimeters = heightInInches*2.54
            if heightInCentimeters != inCentimeters{
                heightInCentimeters = inCentimeters
            }
    }
    }
...
var i = Height(heightInInches: 45.3)
var c = Height(heightInCentimeters: 35.4)
print(i)
print(c)
/*:
